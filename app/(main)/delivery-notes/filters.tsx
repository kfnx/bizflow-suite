...
export function Filters({ onFiltersChange }: FiltersProps) {
  ...
  const handleStatusChange = useCallback(
    (value: string) => {
      handleFiltersChange({ status: value as DeliveryNoteStatus, page: 1 });
    },
    [handleFiltersChange],
  );
        ...
        <Input.Root>
          <Input.Wrapper>
            ...
            <Input.Input
              id='search-input'
              type='text'
              placeholder='Search delivery notes by number, customer, or notes...'
        ...
        <div className='flex items-center gap-2'>
          ...
          <Select.Root value={filters.sortBy} onValueChange={handleSortChange}>
            ...
            <Select.Content>
              ...
              <Select.Item value='delivery-date-asc'>
                Delivery Date (Earliest)
              </Select.Item>
              <Select.Item value='delivery-date-desc'>
