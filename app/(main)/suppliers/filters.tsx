...
export function Filters({ onFiltersChange }: FiltersProps) {
  ...
  const handleFiltersChange = useCallback(
    (newFilters: Partial<SuppliersFilters>) => {
  ...
  const handleCountryChange = useCallback(
    (value: string) => {
      handleFiltersChange({ country: value as SupplierCountry, page: 1 });
    },
    [handleFiltersChange],
  );
        ...
        <Input.Root>
          <Input.Wrapper>
            ...
            <Input.Input
              id='search-input'
              type='text'
              placeholder='Search suppliers by code, name, contact person, or email...'
        ...
        <div className='flex items-center gap-2'>
          ...
          <Select.Root value={filters.sortBy} onValueChange={handleSortChange}>
            ...
            <Select.Content>
              ...
              <Select.Item value='country-asc'>Country (A-Z)</Select.Item>
              <Select.Item value='country-desc'>Country (Z-A)</Select.Item>
            </Select.Content>
          </Select.Root>
        </div>
        ...
        <Button.Root
          ...
          onClick={() => {
            const clearedFilters = {
              search: '',
              country: 'all' as SupplierCountry,
              sortBy: 'newest-first',
              page: 1,
              limit: 10,
            };
